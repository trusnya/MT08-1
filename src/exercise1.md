...
Предназначена для просмотра всех файлов, загруженных страницей, создания и сохранения сниппетов, редактирования CSS и JavaScrip. Панель состоит из 3-х областей:  

1. Navigation – на ней отображаются все файлы используемые на странице  
2. Sources – отображается исходный код  
